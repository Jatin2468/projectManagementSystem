...
public class IssueServiceImpl implements IssueService {
	...
	public Issue createIssue(IssueRequest issueRequest, Long userId)
		...
		// ✅ AUTO GENERATE ISSUE ID (PM-1, PM-2...)
		long count = issueRepository.findByProjectId(issueRequest.getProjectId()).size() + 1;
		issue.setIssueId("PM-" + count);
